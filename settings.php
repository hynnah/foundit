...
// Redirect admins to their dedicated settings page
if (isAdmin()) {
...
<body>
    ...
    <div class="settings-container">
        ...
        <div class="settings-section">
            ...
            <div class="info-box">
                <strong>Account Type:</strong> <?php echo isAdmin() ? 'Administrator' : 'User'; ?>
                <?php if (!isAdmin()): ?>
                    <br><strong>Role:</strong> <?php echo getRoleDisplayName($user_data['role'] ?? 'Unknown'); ?>
                <?php endif; ?>
            </div>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="phone" maxlength="20" pattern="[0-9]+" title="Please enter numbers only"
        ...
        <div class="settings-section">
            ...
            <div class="form-group">
                <label>Role</label>
                <input type="text" class="readonly-field" readonly value="<?php echo htmlspecialchars($user_data['role'] ?? ''); ?>">
            </div>
            <?php endif; ?>
        </div>
    </div>
